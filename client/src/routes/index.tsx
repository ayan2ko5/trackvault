    ...
    children: [
      {
        ...
        children: [
          ...
          { path: "/budgets", element: <PlaceholderPage title="Budgets" /> },
          { path: "/goals", element: <PlaceholderPage title="Savings Goals" /> },
          { path: "/subscriptions", element: <PlaceholderPage title="Subscriptions" /> },
